...
class LedgerDevice {
  ...
  async getAddressInfo (userId, networkCode = 87) {
...
export default {
  ...
  methods: {
    ...
    async handleConnect () {
      // this.userInfo =
      this.userInfo = await device.getAddressInfo(this.userId, 84 /*waves testnet code*/)
      // this.userInfo = await device.getAddressInfo(this.userId, 87 /*waves mainnet code*/)
    }
  }
}
